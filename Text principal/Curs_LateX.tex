...
\begin{tcolorbox}[colframe=black, colback=white, sharp corners, width=\textwidth,boxrule=0.2mm,parbox=false]
    ...
    \end{minipage}
\end{tcolorbox}
LaTeX pot fer aquesta tasca de separar la informació al nostre gust de forma pràcticament automàtica (com veurem a la secció \ref{sec:cap_sec_subsec}) i a més també és capaç de generar automàticament un índex ordenat i polit sense haver d'escriure res explícitament.
